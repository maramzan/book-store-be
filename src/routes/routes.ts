...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    function BookController_getBooks(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.getBooks.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function BookController_searchBooks(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.searchBooks.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function BookController_getBookById(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getBookById.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    function BookController_createBook(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.createBook.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.put(
    ...
    function BookController_updateBook(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.updateBook.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.delete(
    ...
    function BookController_deleteBook(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.deleteBook.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(OrderController.prototype.purchaseBook),

    function OrderController_purchaseBook(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.purchaseBook.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    function OrderController_cancelOrder(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.cancelOrder.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      OrderController.prototype.getOrdersByUserId
    ),

    function OrderController_getOrdersByUserId(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getOrdersByUserId.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
